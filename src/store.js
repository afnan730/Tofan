  ...
  state() {
    return {
      tweets: [
        ...
        {
          text: "تعيد المقاومة تصنيع الأسلحة التي تتساقط على غزة ولا تنفجر، فتضرب بها الصهاينة بعد أن تردها للخدمة بطريقة أفضل مما كانت عليه وهي بأيديهم، فيُقتَلون بأسلحتهم التي قتلوا بها الأبرياء ظلما، مغلفة بعبارة: ذوقوا من نفس الكأس الذي تجرعونه غيركم.#رساله_اليوم #غزه_تنتصر #حلل_يا_دويري",
          type: "image",
          src: p3,
        },
        {
        ...
        {
          text: "إسرائيل تعتقل أكثر من 4695 فلسطينيا في الضفة الغربية، منذ 7 أكتوبر، وفق آخر الإحصائيات الرسمية الصادرة عن جمعية نادي الأسير الفلسطيني، وتواصل عمليات الاقتحام وتهديد العوائل والضرب المبرّح وعمليات التنكيل الواسعة خلال الاعتقال.#رساله_اليوم #غزه_تنتصر #حلل_يا_دويري",
          type: "image",
          src: p1,
        },
        {
